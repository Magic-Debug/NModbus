...
namespace ICU.PowerCollections.Tests {
	...
	public class RedBlackTreeTests
	{
		...
		/// </summary>
		[TestMethod] public void NormalInsert() {
			tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// </summary>
		[TestMethod] public void NormalFind() {
			tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// </summary>
		[TestMethod] public void ReplaceFind() {
			tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// </summary>
		[TestMethod] public void DoNothingFind() {
			tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// </summary>
		[TestMethod] public void InsertFirstFind() {
			tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// </summary>
		[TestMethod] public void InsertLastFind() {
			tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// </summary>
		[TestMethod] public void DeleteFirstLast() {
			tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// </summary>
		[TestMethod] public void InsertRandom() {
			for (int iter = 0; iter < ITERATIONS; ++iter) {
				tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// Do this ITER times.
		/// </summary>
		[TestMethod] public void FindRandom() {
			for (int iter = 0; iter < ITERATIONS; ++iter) {
				tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// Do this ITER times.
		/// </summary>
		[TestMethod] public void ReplaceFindRandom() {
			for (int iter = 0; iter < ITERATIONS; ++iter) {
				tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// Do this ITER times.
		/// </summary>
		[TestMethod] public void InsertFirstFindRandom() {
			for (int iter = 0; iter < ITERATIONS; ++iter) {
				tree = new RedBlackTree<TestItem>(new DataComparer());
				int[] a = CreateRandomArray(iter + 3000, LENGTH, LENGTH / 5, true);
		...
		/// Do this ITER times.
		/// </summary>
		[TestMethod] public void InsertLastFindRandom() {
			for (int iter = 0; iter < ITERATIONS; ++iter) {
				tree = new RedBlackTree<TestItem>(new DataComparer());
		...
		/// </summary>
		[TestMethod] public void DeleteRandom() {
