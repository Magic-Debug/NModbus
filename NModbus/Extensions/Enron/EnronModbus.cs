...
namespace NModbus.Extensions.Enron
{
    ...
    public static class EnronModbus
    {
        ...
        {
            ushort[] registers = master.ReadInputRegisters(slaveAddress, startAddress, (ushort)(numberOfPoints * 2));
        ...
        {
            ushort[] registers = master.ReadHoldingRegisters(slaveAddress, startAddress, (ushort)(numberOfPoints * 2));
        ...
        {
            ushort[] registers = await master.ReadInputRegistersAsync(slaveAddress, startAddress, (ushort)(numberOfPoints * 2));
            return ConvertTo32(registers);
        }
        ...
        {
            ushort[] registers = await master.ReadHoldingRegistersAsync(slaveAddress, startAddress, (ushort)(numberOfPoints * 2));
            return ConvertTo32(registers);
        }
        ...
        {
            ushort[] result = new ushort[registers.Length * 2];
        ...
        public static uint[] ConvertTo32(ushort[] registers)
        {
            ...
            int numberOfResult = registers.Length / 2;

            uint[] result = new uint[numberOfResult];
