...
namespace PLCTool.UC
{
    public class ToolStripRadioButtonMenuItem : ToolStripMenuItem
    {
        ...
        public ToolStripRadioButtonMenuItem(string text, string group = null)
        ...
        public ToolStripRadioButtonMenuItem(string text, EventHandler onClick, string group = null)
        ...
        public ToolStripRadioButtonMenuItem(Image image, string group = null)
        ...
        public ToolStripRadioButtonMenuItem(string text, Image image, string group = null)
        ...
        protected override void OnCheckedChanged(EventArgs e)
        {
            ...
            foreach (ToolStripItem item in Parent.Items)
            {
                ...
                if (radioItem != null && radioItem != this && radioItem.Group == Group && radioItem.Checked)
                {
