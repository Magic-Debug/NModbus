...
{
    public partial class ButtonRadiusEx : Button
    {
        private Color _baseColor = Color.FromArgb(52, 152, 219);//基颜色 
        private Color _hoverColor = Color.FromArgb(17, 128, 189);//激活时的颜色
        private Color _pressColor = Color.FromArgb(17, 128, 210);//按下时的颜色
        ...
        private bool _drawBorder;//是否画边框
        private Color _borderColor = Color.White;//边框颜色

        public ButtonRadiusEx() : base()
        {
            this.SetStyle(
        ...
        [DefaultValue(typeof(Color), "17, 128, 189")]
        ...
        [DefaultValue(typeof(Color), "17, 128, 210")]
            ...
            if (Enabled)
            {
                switch (ControlState)
                {
                    case ControlState.Hover:
                        baseColor = _hoverColor;
                        borderColor = _baseColor;
                        break;
                    case ControlState.Pressed:
                        baseColor = _pressColor;
                        borderColor = _baseColor;
                        break;
                    default:
