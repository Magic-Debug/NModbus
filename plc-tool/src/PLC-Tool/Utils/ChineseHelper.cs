...
namespace FrameworkCommon.Utils
{
    ...
    {
        private static readonly string[][] Allhz =
            new string[][]
			{
        ...
        public static string GetPinyin(string str)
        {
            ...
            foreach (var ch in charary)
            {
                if (IsCharChinese(ch))
                {
                    foreach (string[] t in Allhz)
                    {
                        if (t[1].IndexOf(ch) != -1)
                        {
                            rtnSb.Append(t[0]);
        ...
        /// <summary>
        /// Determines whether [is character chinese] [the specified c].
        /// </summary>
        /// <param name="c">The c.</param>
        /// <returns><c>true</c> if [is character chinese] [the specified c]; otherwise, <c>false</c>.</returns>
